...
WHERE zsl.id IN ( SELECT zsl.Id
					...
					AND IDSP = 9 --AND zsl.ZSL_ID IN ('834672C3-86BB-44BF-A3CD-02447BAB9706','DDDCA872-5570-40A5-99CA-DE2E6B03611C', '14086D3B-1300-4B90-8201-FBBF6B28189B','688FCFB3-A9C9-44B5-9976-68D3B21308A1')
					GROUP BY zsl.id
					HAVING COUNT(*) = 1)
...
BEGIN
	...
	UPDATE D3_ZSL_OMS SET IDSP = 9 WHERE id = @zsl_id
