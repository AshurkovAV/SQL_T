...
FROM [D3_SCHET_OMS] sch                  
 ...
 and sch.id in  (Select 
						...
						FROM [D3_SCHET_OMS] sch  
						WHERE YEAR=2024 and   sch.id IN (18473,18474)
)
 ...
 left JOIN v023 v23 ON v23.K_KSG=ksg.N_KSG  AND s.DATE_2 between v23.DATEBEG AND  isnull(v23.DATEend ,'20241231') --AND year(v23.DATEBEG)>=2019
