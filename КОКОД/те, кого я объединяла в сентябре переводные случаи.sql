SELECT DISTINCT  sch.id AS schit,sch.SchetType, zs.id zslid,s.id
--,s.podr
--,k.name
...
--INTO temp_09_perevod
FROM [D3_SCHET_OMS] sch                  
  inner join D3_PACIENT_OMS p on p.d3_scid=sch.id 
  and sch.year=2020 and sch.month=9-- AND sch.code_mo=460061 AND sch.id IN (502)-- (495,486)
 ...
 JOIN temp_09_perevod g ON g.id=s.ID
