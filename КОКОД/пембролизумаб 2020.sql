...
left join KOKOD_OTD k on k.kod_otd=sl.podr
		...
		(									
			...
			AND LekPr.REGNUM IN  (001691)--(000246,001691, 001554,001038,002722) -- таргет
...
--GROUP BY nhistory,zsl.USL_OK
	--HAVING COUNT(*)>1
	--AND nhistory LIKE '2418/09621'
	AND p.smo NOT LIKE '46004' AND sum_m=373297.33
	--ORDER BY 