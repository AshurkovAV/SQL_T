select distinct sch.id AS shit,zs.ID AS zslid, s.id AS slid,ksg.id as ksg_id , ou.ID AS ouid,ksg.N_KSG,v23.[N_KSG] ksg_name,s.nhistory
,lek.CODE_SH, lek.REGNUM, spr.crit
...
FROM [D3_SCHET_OMS] sch                  
 ...
 JOIN D3_LEK_PR_OMS AS lek ON lek.D3_ONKUSLID=ou.ID
   ...
   where  ds1 between 'C81' and 'C96.z' and (crit.crit  like 'gem%') 
   AND spr.crit<> crit.crit