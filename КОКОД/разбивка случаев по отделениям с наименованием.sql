...
SELECT DISTINCT  sch.id AS schit,sch.month, zs.id zslid,s.iddokt,s.podr,k.name,p.fam,p.im,p.ot,p.dr, p.npolis,zs.DATE_Z_1, zs.DATE_Z_2, s.nhistory,s.ds1,ksg.n_ksg,zs.vidpom,v23.NameWithID, zs.ishod,v12.IZNAME,v009.NameWithID v9, zs.sumv,zs.usl_ok
--into ztemp_desh_Cdelete_052020
FROM [D3_SCHET_OMS] sch                  
  inner join D3_PACIENT_OMS p on p.d3_scid=sch.id 
  and sch.year=2020 AND sch.id  IN (329,350)
