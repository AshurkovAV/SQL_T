...
left join[V019] v019 on cast(v019.IDHM as int)=sl.metod_hmp  											
		...
		where sa.id is null and 									
			...
			--and sch.month between 1 and 9		
			 (YEAR(zsl.DATE_Z_2)=2022 AND MONTH(zsl.DATE_Z_2) BETWEEN 1 AND 12 OR  YEAR(zsl.DATE_Z_2)=2023 AND MONTH(zsl.DATE_Z_2) BETWEEN 1 AND 6)-- период оказания						
