SELECT --distinct sch.id AS shit,sch.month,sch.NSCHET,s.nhistory,zs.ID AS zslid, s.id AS slid,p.smo,
...
left JOIN D3_LEK_PR_OMS AS lek ON lek.D3_ONKUSLID=ou.ID
 WHERE-- zs.id=2398572
 ou.usl_tip in (2,4) and lek.id is  null and sch.year=2021 and month=12
