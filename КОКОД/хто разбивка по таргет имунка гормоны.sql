...
SELECT t.year,t.usl_ok,vid_him, COUNT (DISTINCT t.npolis) [kol_vo pac]
FROM(
select DISTINCT sch.[year],zsl.USL_OK,p.NPOLIS, nhistory, CASE WHEN LekPr.REGNUM IN (000246,001691, 001554,001038,002722) then 'таргет'
			                                                   WHEN LekPr.REGNUM in (002120,002121,000300,001705,002302,001653,000412) then 'имунка'
			                                                   WHEN LekPr.REGNUM IN (000438,002263) then 'gormon'
			                                                   ELSE 'him' END vid_him
...
left join[V019] v019 on cast(v019.IDHM as int)=sl.metod_hmp  											
		...
		where 									
			...
			--ds 1
			--AND (ds1 BETWEEN 'C15' AND 'C16.z'
			--    OR ds1 BETWEEN 'C18' AND 'C20.z'
			--    OR ds1 BETWEEN 'C25' AND 'C25.z'
			--    OR ds1 BETWEEN 'C33' AND 'C34.z'
			--    OR ds1 BETWEEN 'C43' AND 'C43.z'
			--    OR ds1 BETWEEN 'C50' AND 'C50.z'
			--    OR ds1 BETWEEN 'C51' AND 'C56.z'
			--    OR ds1 BETWEEN 'C60' AND 'C67.z'
			--    OR ds1 BETWEEN 'C81' AND 'C85.z'
			--    OR ds1 BETWEEN 'C00' AND 'C14.z'
			--    OR ds1 BETWEEN 'C23' AND 'C23.z'
			--    OR ds1 BETWEEN 'C37' AND 'C38.z'
			--    OR ds1 BETWEEN 'C40' AND 'C41.z'
			--    OR ds1 BETWEEN 'C80' AND 'C80.z'
			--    )
			    
				
			--ds 2
			--AND (ds1 BETWEEN 'C00' AND 'C14.z'
			--	OR ds1 BETWEEN 'C16' AND 'C16.z'
			--	OR ds1 BETWEEN 'C61' AND 'C67.z'
			--   OR ds1 BETWEEN 'C43' AND 'C43.z'
			--   OR ds1 BETWEEN 'C50' AND 'C50.z'
			--    OR ds1 BETWEEN 'C34' AND 'C34.z'
			--    OR ds1 BETWEEN 'C18' AND 'C20.z'
		 ...
		 --препараты							
			...
			AND (LekPr.REGNUM IN (000246,001691, 001554,001038,002722) -- таргет
			 or LekPr.REGNUM in (002120,002121,000300,001705,002302,001653,000412) --имунка
			 OR LekPr.REGNUM IN (000438,002263) --gormon
			     )
			
			---
			
			AND sl.podr IN ('460061106006','460061106017','460061206014')
			

)t
GROUP BY t.year,t.usl_ok,vid_him
ORDER BY t.year,t.usl_ok,vid_him
