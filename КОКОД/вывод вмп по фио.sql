...
,k.name
,p.fam,p.im,p.ot,p.dr, p.npolis,zs.DATE_Z_1, zs.DATE_Z_2, s.nhistory,s.ds1,s.METOD_HMP, zs.ishod,v12.IZNAME,v009.NameWithID v9, s.sum_m,s.MP_HMP --,zs.sumv,zs.usl_ok

FROM [D3_SCHET_OMS] sch                  
  inner join D3_PACIENT_OMS p on p.d3_scid=sch.id 
  and sch.year=2021 and sch.month=3 AND sch.code_mo=460061 AND  sch.id IN (1920)
...
--where zs.id in (1528887, 1528888)