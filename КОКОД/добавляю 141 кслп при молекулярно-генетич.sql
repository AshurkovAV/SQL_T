...
--UPDATE Ksg SET Ksg.it_sl=Ksg.it_sl+0.04--, Ksg.sl_k=1
--UPDATE zs SET zs.sumv=ROUND((zs.sumv/ksg.it_sl)*(ksg.it_sl+0.04),2)
...
WHERE ksg.SL_K=1 AND zs.USL_OK=1  AND zs.id IN (263538,
263640,
263703,
264641,
264641,
