...
DECLARE @FactExpertCriterion TABLE(
	...
	VALUES ('',1,53,'',1,1,'01.04.2020',NULL,2,'--003K.00.0530_Метод ВМП не соответствует виду ВМП
...
','003K.00.0530_Метод ВМП не соответствует виду ВМП','003K.00.0530_Метод ВМП не соответствует виду ВМП','Метод ВМП не соответствует виду ВМП',1,0.00,4,1.00,9,2,'003K.00.0530','CE800910-A871-40F6-A86C-3E0610AA06B0')
