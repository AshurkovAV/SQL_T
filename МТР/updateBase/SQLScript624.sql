...
--Несоответствие результата обращения и исхода заболевания (летальность) RSLT={205, 206}  ISHOD=204
...
AND v12.IDIZ  not IN (204)','003K.00.0341 Несоответствие результата обращения и исхода заболевания (летальность) RSLT={205, 206}  ISHOD=204','003K.00.0341 Несоответствие результата обращения и исхода заболевания (летальность) RSLT={205, 206}  ISHOD=204','Несоответствие результата обращения и исхода заболевания (летальность)',1,0.00,4,1.00,9,2,'003K.00.0341','CF09C4AA-7AF6-40A5-9B9A-3B2A80FE2B68')
