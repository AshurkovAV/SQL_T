...
EXEC [dbo].[versionÑheck] 571

DECLARE @sql NVARCHAR(MAX) =
'ALTER VIEW [ZslEventShortView]
AS
SELECT        t0.ExternalId, t0.MedicalExternalId, t1.AccountId, t1.MedicalAccountId, t0.ZslMedicalEventId, zme.ZmedicalEventId AS EventId, t0.PatientId, t2.Surname, t2.PName AS Name, t2.Patronymic, t2.Birthday, 
                         ...
                         AS Speciality, t9.IDRMP AS Result, t10.IDIZ AS Outcome, t11.STNAME AS PaymentStatus, zme.MEC, zme.MEE, zme.EQMA, zme.Comments AS EventComments, dbo.V008.IDVMP AS AssistanceType, dbo.V008.VMPNAME,
