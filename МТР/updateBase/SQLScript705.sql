ALTER VIEW [dbo].[ZEventShortView]
AS
...
t0.PatientId, t2.Surname, t2.PName AS Name, t2.Patronymic, t2.Birthday, 
						 ...
						 t4.smocod AS Insurance, t5.IDUMP AS AssistanceConditions, 
                          m001.IDDS + '  ' + m001.DSNAME AS Diagnosis, 
                         ...
                         CAST(v002.Id AS NVARCHAR(5)) + '  ' + v002.PRNAME AS Profile, 
                         CAST(v.Id AS NVARCHAR(5)) + '  ' + v.SPECNAME  AS Speciality,
                         ...
                         '' HighTechAssistanceType, --v018
						 '' HighTechAssistanceMethod --v019
FROM dbo.ZslFactMedicalEvent AS t0 
INNER JOIN dbo.[GetZslEvent] sl ON t0.ZslMedicalEventId = sl.ZslMedicalEventId
...
LEFT JOIN V021 AS v ON sl.prvs = v.Id 
LEFT JOIN v002 ON sl.profil = v002.IDPR  
LEFT JOIN m001 on m001.Id = sl.ds1
