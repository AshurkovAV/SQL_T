...
BEGIN TRY
INSERT INTO @N002 ([ID_St],[DS_St],[KOD_St],[DATEBEG],[DATEEND])
SELECT [ID_St],[DS_St],[KOD_St],[DATEBEG],[DATEEND]
...
UPDATE @N002 SET DATEEND = NULL WHERE DATEEND = '19000101' 
...
SET ID_St = t1.ID_St
      ...
      ,DATEEND = t1.DATEEND
FROM N002 as t
JOIN @N002 as t1 on t.ID_St = t1.ID_St

INSERT INTO N002
       ([ID_St],[DS_St],[KOD_St],[DATEBEG],[DATEEND])
SELECT  [ID_St],[DS_St],[KOD_St],[DATEBEG],[DATEEND]
FROM @N002
WHERE ID_St NOT IN (
        SELECT t1.ID_St  
