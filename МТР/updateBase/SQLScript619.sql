...
WHERE fec.Comments LIKE '003K.00.0210_Взаимное несоответствие исхода заболевания, результата обращения(При RSLT={102,%'

EXEC [dbo].[versionUpdate] 619
COMMIT TRAN;		
END TRY
		BEGIN CATCH			
