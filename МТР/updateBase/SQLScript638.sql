...
DECLARE @FactExpertCriterion TABLE(
	...
	VALUES ('',1,53,'',1,1,'01.04.2020',NULL,2,'--003K.00.0610 Несоответствие диагноза осложнения возрасту пациента
...
--and a.date >''20200101''
','003K.00.0610 Несоответствие диагноза осложнения возрасту пациента','003K.00.0610 Несоответствие диагноза осложнения возрасту пациента','Несоответствие диагноза осложнения возрасту пациента',1,0.00,4,1.00,9,2,'003K.00.0610','18134580-38DC-4471-B06F-BC0BEA64D7F7')
	
	DELETE FROM FactExpertCriterion WHERE [Description] LIKE '003K.00.0610%'
	
	IF NOT EXISTS(SELECT * FROM FactExpertCriterion WHERE [Description] LIKE '003K.00.0610%' ) 	
	BEGIN
