...
ALTER TABLE [dbo].[ZFactMedicalServicesOnk]  WITH CHECK ADD  CONSTRAINT [FK_ZFactMedicalServicesOnk_ZFactMedicalServices] FOREIGN KEY([ZmedicalServicesId])
REFERENCES [dbo].[ZFactMedicalServices] ([ZmedicalServicesId])
GO

ALTER TABLE [dbo].[ZFactMedicalServicesOnk] CHECK CONSTRAINT [FK_ZFactMedicalServicesOnk_ZFactMedicalServices]
GO
