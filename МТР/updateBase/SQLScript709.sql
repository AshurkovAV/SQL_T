CREATE VIEW [dbo].[ZslServiceShortView]
AS
SELECT        t0.ExternalId, t0.MedicalExternalId, t1.AccountId, t1.MedicalAccountId, t0.ZslMedicalEventId, zme.ZmedicalEventId AS EventId, t0.PatientId, t2.Surname, t2.PName AS Name, t2.Patronymic, t2.Birthday, 
                         ...
                         CASE WHEN zme.Dn = '1' THEN '1  Состоит'
							  ...
							  usl.ServiceCode, usl.ServiceName
FROM            dbo.ZslFactMedicalEvent AS t0 INNER JOIN
                         dbo.ZFactMedicalEvent AS zme ON zme.ZslMedicalEventId = t0.ZslMedicalEventId 
                         LEFT OUTER JOIN ZFactMedicalServices usl ON usl.ZmedicalEventId = zme.ZmedicalEventId
                         ...
                         LEFT OUTER JOIN dbo.ZFactKsgKpg AS ksg ON ksg.ZmedicalEventId = zme.ZmedicalEventId LEFT OUTER JOIN
