DROP TABLE ztemp_du_tek
DROP TABLE ztemp_du_pred
GO 

SELECT dpo.FAM, dpo.IM, dpo.OT, dpo.DR,
	dbo.GROUP_CONCAT_DS(DISTINCT ysme.NameWithID, N' , ', 1)NameWithID,
	(CASE WHEN dbo.GROUP_CONCAT_DS(DISTINCT ysme.LPU_ID, N' , ', 1) = '460006' THEN 'Çàâîäñêàÿ'
	      WHEN dbo.GROUP_CONCAT_DS(DISTINCT ysme.LPU_ID, N' , ', 1) = '460026' THEN 'Ñîþçíàÿ' ELSE '×òî-òî ïîøëî íå òàê' END) lpu_id
--	dbo.GROUP_CONCAT_DS(DISTINCT ysme.LPU_ID, N' , ', 1)LPU_ID
	--CASE WHEN ysme.LPU_ID = 460006 THEN 'ÇÀÂÎÄÑÊÀß' ELSE 'ÑÎÞÇÍÀß' END gb, ysme.NameWithID
		INTO ztemp_du_pred
