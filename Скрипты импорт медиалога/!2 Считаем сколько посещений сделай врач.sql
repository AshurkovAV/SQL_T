...
INSERT INTO @docTab(id,NAME, profil, prvs, snils,det,vidpom,idmis)VALUES(35,'Барсук Т. И.',       65, 46,  '037-674-814 89',0,13, 2600012)
INSERT INTO @docTab(id,NAME, profil, prvs, snils,det,vidpom,idmis)VALUES(41,'Постников С. В.',    162, 45, '037-674-818 93',0,13, 2600099)
INSERT INTO @docTab(id,NAME, profil, prvs, snils,det,vidpom,idmis)VALUES(439,'СОМОВА И. В.',      162, 45, '140-173-879 40',0,13, 2600192)

DECLARE @lpu NVARCHAR(6) = '460026'

SELECT IDDOKT, NAME, iddoc, COUNT(*)
FROM (
...
CASE WHEN CAST(ED_TREATMENT_RESULTS.ED_TREATMENT_RESULT_CODE AS INT) = 342 THEN 314 ELSE CAST(ED_TREATMENT_RESULTS.ED_TREATMENT_RESULT_CODE AS INT) END RSLT,--Результат обращения
...
WHERE FM_BILL.BILL_DATE >='2019-04-01'AND FM_BILL.BILL_DATE <= '2019-04-30'
--AND MEDECINS.MEDECINS_ID = 2600214
