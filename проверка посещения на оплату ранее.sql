...
BEGIN
	...
	IF(	select COUNT(*)
		...
		where sl.id <> @id
				...
				and DATE_2 = @DATE_2  and sl.PROFIL=@profil and DSCHET!=@dschet) > 0
...
update zsl set EXP_COMENT = 'проверка посещения на оплату ранее' + CAST(zsl.D3_SCID AS NVARCHAR(10))
from d3_zsl_oms zsl
